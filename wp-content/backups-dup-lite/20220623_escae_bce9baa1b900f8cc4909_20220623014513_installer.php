...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220623_escae_bce9baa1b900f8cc4909_20220623014513_archive.zip';
	const ARCHIVE_SIZE		 = '82228756';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'bce9baa-23014513';
    const SECONDARY_PACKAGE_HASH = '94c9be6-23014513';
	const VERSION			 = '1.4.6';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.4.6==');
		self::log('----------------------------------------------------');
